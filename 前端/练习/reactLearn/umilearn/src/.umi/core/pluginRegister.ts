...
import * as Plugin_0 from 'E:/hfx学习树/前端/练习/reactLearn/umilearn/src/.umi/plugin-dva/runtime.tsx';
...
import * as Plugin_3 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_0,
    path: 'E:/hfx学习树/前端/练习/reactLearn/umilearn/src/.umi/plugin-dva/runtime.tsx',
  });
  plugin.register({
    apply: Plugin_1,
