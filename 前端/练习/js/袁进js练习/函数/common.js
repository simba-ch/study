 ...
 * 该函数用于判断数组是否是稀松数组
 */
function fnHasEmptyInArray(arr) {
    var len = arr.length;
    for (var i = 0; i < len; i++) {
 ...
 */
function fnGetMoreFreqInArray(arr) {
    var len = arr.length,
        objResult,
        objRoom = {};
    for (var i in arr) {
